...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        {
          text: this.$t('VIEWS.BONOLOTO.STATS.OCCURRENCES_BY_REIMBURSEMENT_STATS.TABLE.REIMBURSEMENT.LABEL'),
          align: 'center',
          sortable: true,
          value: 'reimbursement',
        },
        {
          text: this.$t('VIEWS.BONOLOTO.STATS.OCCURRENCES_BY_REIMBURSEMENT_STATS.TABLE.OCCURRENCES.LABEL'),
          align: 'center',
          sortable: true,
          value: 'occurrences',
        },
